...
Future<T> _showFlushbar<T>(
  ...
  assert(builder != null);
  return Navigator.of(context, rootNavigator: false).push(new DuDialogRoute<T>(
        ...
        case AnimationStatus.dismissed:
          {
            ...
            (widget._result == null && context != null)
                ? Navigator.maybePop(context)
                : Navigator.maybePop(context, widget._result);
      ...
      case FlushbarPosition.TOP:
        {
          ...
          barInsets = EdgeInsets.only(top: 0.0); //原本是24，但是24在我使用过程中有问题，所以我改成0了
          _setBoxShadow();
  ...
  Widget _getFlushbar() {
    if (widget.isDismissible) {
      return new Dismissible(
        ...
        child: (widget.userInputForm != null)
